        ...
        if (!isset($_SESSION['usuarioid'])) {
            ...
            <script >
                ...
                function cargar_popup_editar(id) {
                    ...
                    document.getElementById("descripcion_e").value = ids[2];
                    document.getElementById("fecha_e").value = ids[3];
                    document.getElementById("hora_e").value = ids[5];
                    //Se limpia estado
                    $('#result_e').html('');
                }
        ...
        <body onload="nobackbutton();
            ...
            <main>
                ...
                <div >
                    ...
                    <div align="right">
                        <button title="Crear Usuario" id="boton_crear" <?php echo $disabled_copy; ?> class="<?php echo $class_copy; ?>"></button>    
                    </div>
                                    ...
                                    <div style="background-color: #E8E8E8">
                                        <table style="width: 400px">
                                            <tr>
                                                ...
                                                <td><input style="width: 180px;" id="titulo" name="titulo" type="text" maxlength="25" required="Por favor ingrese el título del evento."/></td>
                                            </tr>
                                            <tr>
                                                <td><label for="descripcion">Descripción (*):</label></td>
                                                <td><input style="width: 180px;" id="descripcion" name="descripcion" type="text" maxlength="60" required="por favor ingrese la descripción del evento."/></td>
                                            </tr>
                                            <tr>
                                                <td>Fecha (*):</td>
                                                <td><input style="width: 180px;" readonly="true" id="fecha" name="fecha"  type="date" required="Por favor ingrese la fecha del evento."/></td>
                                            </tr>   
                                            <tr>
                                                <td><label for="titulo">Hora (de 0 a 24) (*):</label></td>
                                                <td><input style="width: 180px;" min="0" max="23" id="hora" name="hora" type="number" maxlength="2" required="Por favor ingrese la hora del evento."/></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                    ...
                                    <div style="background-color: #E8E8E8">
                                        <table style="width: 400px">
                                            <tr>
                                                ...
                                                <td><input style="width: 180px;" id="titulo_e" name="titulo_e" type="text" maxlength="25" required="Por favor ingrese el título del evento."/></td>
                                            </tr>
                                            <tr>
                                                <td><label for="descripcion_e">Descripción (*):</label></td>
                                                <td><input style="width: 180px;" id="descripcion_e" name="descripcion_e" type="text" maxlength="60" required="por favor ingrese la descripción del evento."/></td>
                                            </tr>
                                            <tr>
                                                <td>Fecha (*):</td>
                                            ...
                                            <tr>
                                                <td><label for="hora_e">Hora (de 0 a 24) (*):</label></td>
                                                <td><input style="width: 180px;" min="0" max="23" id="hora_e" name="hora_e" type="number" maxlength="2" required="Por favor ingrese la hora del evento."/></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                    ...
                    <div id="popup_eliminar">
                        ...
                        <div  class="art-postcontent">
                            <div align="center">
                                <form id="form_eliminar" name="form_eliminar" method="post" onsubmit="return submitFormEliminar()" action="src/eliminar_usuarioCB.php">
                                    <div style="background-color: #E8E8E8">
                                        <table style="width: 400px">
                                            <tr>
                                                <td><label for="cedula_e">¿Realmente desea eliminar el evento?. Recuerde que para activar nuevamente el evento necesitaría la aprobación del administrador del sistema.</label></td>                                           
                                            </tr>
                                            <tr>
                                                <td colspan="2">
