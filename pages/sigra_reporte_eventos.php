...
<head>
    ...
    if (preg_match("/MSIE/i", "$browser")) {
        ...
        if (!isset($_SESSION['usuarioid'])) {
            ...
            <script src="js/sigra/js-reportes.js" type="text/javascript" language="javascript"></script>
                    ...
                    <main>
                        <div >
                            ...
                            <div align="center" style="background-color: #004669">
                                <h2 id='p_fieldset_autenticacion_2'>REPORTE DE EVENTOS</h2>
                            </div>
                            <br/>                    
                            <div>
                                <div id="filtros">
<!--                                    <input type="hidden" id="accion" value="listado"/>-->
                                    ...
                                    <?php include "sigra_filtro2.php"; ?>
                                </div>
                                <div id="btns" align="center">
                                    <a class="botones" id="asistentes" >Reporte de Asistentes</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a class="botones" id="registrados" >Reporte de Registrados</a>
                                </div>
                                <br/>
                                <div id="carg" >  </div>
