<head>
    ...
    if ($cod_error == 'X01') {
        ...
        $detalle_error = 'Su navegador no es compatible con algunos complementos con el SIGRA. Recomendamos descargue un navegador actualizado (Chrome, Firefox) e intente nuevamente. ';
    }
    if ($cod_error == 'X02') {
    ...
    if ($cod_error == 'X05') {
        ...
        $detalle_error = 'Su usuario se encuentra inactivo, por favor comuniquese con el administrador del SIGRA.';
    }
    if ($cod_error == 'X06') {
        $titulo_error = 'SIGRA-Unadista Cerrado';
        $detalle_error = 'El Sistema de Información del Estudiante Unadista se encuentra cerrado.';
    }
    if ($cod_error == 'X07') {
        $titulo_error = 'SIGRA en Mantenimiento';
    ...
    include "../template/sigra_link.php";
    ?>
...
<body onload="nobackbutton();">
    ...
    <?php
    //Encabezado
    include "../template/sigra_head.php";
    ?>
...
<?php
//Pie de pagina
include "../template/sigra_footer.php";
?>
</body>
