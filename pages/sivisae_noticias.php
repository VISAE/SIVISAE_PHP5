...
<head>
    ...
    if (preg_match("/MSIE/i", "$browser")) {
        ...
        if (!isset($_SESSION['usuarioid'])) {
            ...
            <script src='js/varios/script-cargar-imagenes.js' type='text/javascript' language='javascript'></script>
                ...
                function submitFormCrear() {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            var tx = data;
                            if (data == "-1") {
                                $('#result').html('La fecha de la noticia debe ser mayor o igual a la fecha actual');
                            } else
                            {
                                $('#result').html('La noticia ha sido registrada con éxito.');
                                limpiaForm(form);
                                //Se recarga la grilla
                                listaGrilla();
                                $('#adicionar_imagen').show();
                                $('#idNoticia').val(tx);
                            }
                ...
                <div >
                    ...
                    <div id="popup_crear">
                        ...
                        <div  class="art-postcontent">
                            <div align="center">
                                <form id="form_crear" name="form_crear" method="post" enctype="multipart/form-data" onsubmit="return submitFormCrear()" action="src/creacion_noticiaCB.php">
                                    <div style="background-color: #E8E8E8">
                                        <table style="width: 400px">
                                            ...
                                            <tr>
                                                <td><label for="perfil">Perfiles:</label></td>
                                                <td>
                                                    <?php
                                                    ...
                                                    $sbHtML2.= "<option value='0'>TODOS</option>";
                                ...
                                <div id="adicionar_imagen" style="background-color: #E8E8E8; display:none;">
                                    <table style="width: 500px">
                                        <tr>
                                            <td>Imagen</td>
                                            <td>
                                                <input type='file'  multiple='multiple' id='imagen'>
                                                <button id='enviar_arch_t' onclick='return subirImagenes()'>Enviar Imagen</button>
                                            </td><!-- Este es nuestro campo input File-->
                                        </tr>
                                        <tr>
                                            <td colspan="2"><div class='mensaje'></div></label></td>
                                        </tr>
                                        <tr>
                    ...
                    <div id="popup_editar">
                        ...
                        <div  class="art-postcontent">
                            <div align="center">
                                <form id="form_editar" name="form_editar" method="post" onsubmit="return submitFormEditar()" >
                                    <div style="background-color: #E8E8E8">
                                        <table style="width: 400px">
                                            <tr>
