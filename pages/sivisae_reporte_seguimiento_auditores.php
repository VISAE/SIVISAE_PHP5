        ...
        if (!isset($_SESSION['usuarioid'])) {
            ...
            <script type="text/javascript" language="javascript">
                    ...
                    if ($('#periodo').val() !== '') {
                        if ($('#fecha_inicio').val() !== '') {
                            if ($('#fecha_fin').val() !== '') {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: 'src/seguimiento_AuditoresCB.php',
                                    data: dataString,
                                    beforeSend: function () {
                                        $("#spinner").show();
                                    },
                                    success: function (data) {
                                        ...
                                        $("#list_estudiantes").on("click", ".pagination a", function (e) {
                                            ...
                                            $("#list_estudiantes").load("src/proyeccionCB.php", {
                                                "page": page,
                                                "auditor": aud,
                                                "registros": reg,
                                                "buscar": search,
                ...
                function crearReporte() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'src/reporte_seguimiento_aud.php',
                        data: dataS,
                        beforeSend: function () {
                            $('#spinner').show();
                        },
                ...
                <div >
                    ...
                    <div align="center" style="background-color: #004669">
                        <h2 id='p_fieldset_autenticacion_2'>
                            REPORTE SEGUIMIENTOS DE AUDITORES DE SERVICIOS A LOS ESTUDIANTES
                        </h2>
                    </div>
