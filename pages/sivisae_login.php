...
if ($mantenimiento == 1) {
    ...
    <html>
        <body bgcolor="#000000">
            <div align="center">
                <img src="template/imagenes/generales/mantenimiento_sivisae.jpg" width="80%" height="90%"/>
            </div>
            <div align="center">
                </br>
                <font color="#FFFFFF">ESTE SITIO SE ENCUENTRA EN MANTENIMIENTO </br> </font>
...
<head>
    ...
    if (preg_match("/Msivisae/i", "$browser")) {
                ...
                <div>
                    ...
                    <div id="banner">
                        <ul class="rslides" id="slider1">
                            <li><img width="100%" height="100%" src="https://sivisae.unad.edu.co/sivisae/template/imagenes/banner/sivisae_fondo_0.png" /></li>
                            <li><img width="100%" height="100%" src="https://sivisae.unad.edu.co/sivisae/template/imagenes/banner/sivisae_fondo_1.png" /></li>
                            <li><img width="100%" height="100%" src="https://sivisae.unad.edu.co/sivisae/template/imagenes/banner/sivisae_fondo_2.png" /></li>
                            <li><img width="100%" height="100%" src="https://sivisae.unad.edu.co/sivisae/template/imagenes/banner/sivisae_fondo_3.png" /></li>
                        </ul>
                    </div>
                        ...
                        <form  name="login" method="post" action="src/loginCB.php">
                            <fieldset id='fieldset_autenticacion'>
                                ...
                                <p style="text-align: center">
                                    <input  maxlength="50" required="required" title="Por favor ingrese su usuario. El usuario debe ser mÃ­nimo de seis caracteres" autocomplete="off" class="input_fieldset_autenticacion" type="text" id="usuario" name="usuario" value=""/></p> 
                                <p id='p_fieldset_autenticacion'><label for="password"><strong>Contraseña</strong></label></p>
                                <p style="text-align: center">
                                    <input  maxlength="45" required="required" title="Por favor ingrese su contraseÃ±a" autocomplete="off" class="input_fieldset_autenticacion" type="password" id="password" name="password" value = ""/></p> 
