                    ...
                    <div align='center'>
                        <table>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input style="width: 300px;" id="nombre" name="nombre" class="form-control" type="text" maxlength="30" tabindex="5" placeholder="Nombre aqui" required/>
                                </td>
                                <td class="aud">Fecha Evento
                                    <input style="width: 180px;" id="fecha_evento" name="fecha_evento"  type="date" required="Por favor ingrese la fecha de evento."/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="2">
                                    <input style="width: 300px;" id="apellido" name="apellido" class="form-control" type="text" maxlength="30" tabindex="6" placeholder="Apellido aqui" required/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="2">
                                    <input style="width: 300px;" id="email" name="email" class="form-control" type="email" maxlength="30" tabindex="7" placeholder="nombre@correo.com" required/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="2">
                                    <input style="width: 300px;" id="telefono" name="telefono" class="form-control" type="tel" maxlength="30" tabindex="8" placeholder="Teléfono aqui" required/>
                                </td>
                            </tr>
                            <tr>
                                <td>
