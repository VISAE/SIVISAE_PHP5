...
if (isset($_POST["buscar"]) && $_POST["buscar"] != '') {
    $temp = $consulta->ReporteMatriculadosExcel($_POST["buscar"], $periodo, $zona, $cead, $escuela, $programa);
} else {
    $temp = $consulta->ReporteMatriculadosExcel('n', $periodo, $zona, $cead, $escuela, $programa);
}
...
$columnas = array("DOCUMENTO ESTUDIANTE", "NOMBRE", "TELÉFONO", "CORREO", "INSTITUCIONAL", "PROGRAMA", "ESCUELA", "CENTRO", "ZONA", "PERIODO", "TIPO");
$nombre_arch = "Reporte Matriculados";
$desc = "Reporte que contiene un listado de estudiantes matriculados.";
