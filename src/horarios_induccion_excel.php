...
$temp = $consulta->HorariosInduccionesExcel($periodo, $zona, $cead, $escuela);
...
$columnas = array("ZONA", "CEAD", "ESCUELA", "PERIODO ACADEMICO", "FECHA Y HORA INICIAL", "FECHA Y HORA FINAL", "SALÓN", "CUPOS", "INSCRITOS", "TIPO INDUCCION");
