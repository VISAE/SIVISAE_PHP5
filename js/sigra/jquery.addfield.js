...
var clickID = parseInt($(this).parent('div').attr('id').replace('titulo_',''));
// Genero el nuevo numero id
var newID = (clickID+1);
// Creo un clon del elemento div que contiene los campos de texto
$newClone = $('#titulo_'+clickID).clone(true);
//Le asigno el nuevo numero id
$newClone.attr("id",'titulo_'+newID);
...
$newClone.insertAfter($('#titulo_'+clickID));
//Cambio el signo "+" por el signo "-" y le quito el evento addfield
$("#"+clickID).val('-').unbind("click",addField);
//Ahora le asigno el evento delRow para que borre la fia en caso de hacer click
